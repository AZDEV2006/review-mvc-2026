...
|---|---|---|---|
| 30 ส.ค. 2569 | ChatGPT Codex | ตรวจโครงสร้าง MVC และช่วยเติมเอกสาร `SUBMISSION.md` | นำไปจัดทำคำอธิบายวิธีรัน ตาราง requirements และผลทดสอบ |
| 30 ส.ค. 2569 | ChatGPT Codex | ช่วยรันตรวจ endpoint หลักของโปรแกรม | ใช้ผลการทดสอบจริงเติมในตาราง T1-T6 |
